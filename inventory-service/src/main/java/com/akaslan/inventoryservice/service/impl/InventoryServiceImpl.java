...
public class InventoryServiceImpl implements InventoryService {
    ...
    public InventoryResponse getInventoryByProductId(Long productId) {
        ...
        // MİMARİ DOKUNUŞ: Eğer depoda ürün yoksa hata fırlatma, stok 0 olarak dön.
        // Bu sayede sepet servisi null pointer yemez.
    ...
    public void deductInventory(Long productId, Integer quantityToDeduct) {
        ...
        // Stok düşerken acımasız olmalıyız. Ürün yoksa sipariş iptal edilmeli.
